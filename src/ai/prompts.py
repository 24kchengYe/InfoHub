...
- reason_en: A compelling 1-2 sentence recommendation reason in English explaining why this is worth reading
- reason_zh: 用中文写1-2句引人入胜的推荐理由，解释为什么值得关注
- summary_en: A detailed 2-3 sentence summary in English covering what happened, key details, and implications
- summary_zh: 用中文写2-3句详细摘要，涵盖事件内容、关键细节和影响
- title_zh: Chinese translation of the title (简体中文). Keep technical terms like GPT, CUDA, etc. in English.
- title_en: English translation of the title. If the original title is already in English, keep it as-is. If Chinese, translate to English.
- category: Classify into ONE of these categories: {categories}
...
{{
  "score": <number>,
  "reason_en": "<1-2 sentence recommendation in English>",
  "reason_zh": "<用中文写的1-2句推荐理由>",
  "summary_en": "<2-3 sentence detailed summary in English>",
  "summary_zh": "<用中文写的2-3句详细摘要>",
  "title_zh": "<中文标题翻译>",
